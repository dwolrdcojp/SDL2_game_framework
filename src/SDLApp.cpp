...
SDLApp::SDLApp(Uint32 subsystemFlags, const char* title, int x , int y, int w, int h){
	...
	// Default value 
	m_maxFrameRate = 60;
	// Initialize the video subsytem, if it returns less than 1, then an error code will be received
	...
	// Request the window to be created for our platform
	// The parameters are for the title, x and y positions, and width and height of the window.
